        ...
        <div className="mt-6">
          <form className="space-y-4">
            ...
            <div className="text-xs text-gray-500">
              By submitting this form, I agree to Orb's{" "}
              <a
                href="https://www.withorb.com/website-terms-of-use"
                className="text-orbBlue hover:underline"
              >
                Website Terms of Use
              </a>{" "}
              and{" "}
              <a
                href="https://www.withorb.com/privacy-policy"
                className="text-orbBlue hover:underline"
              >
                Privacy Policy
              </a>
              . I understand that Orb may use my information to send me product
              news and marketing communications. I can unsubscribe at any time
              through the unsubscribe link in any message or by contacting Orb
              directly.
            </div>
