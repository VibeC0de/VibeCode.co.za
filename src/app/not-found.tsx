          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            >
              <div className="relative mb-8 mx-auto w-40 h-40">
                <div className="absolute inset-0 bg-orbBlue-100 dark:bg-orbBlue-900/30 rounded-full animate-pulse"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-8xl font-bold text-orbBlue-600 dark:text-orbBlue-400">404</span>
                </div>
              </div>
            </motion.div>
            ...
            >
              <p>
                Need immediate assistance? <Link href="/contact" className="text-orbBlue-600 hover:text-orbBlue-700 dark:text-orbBlue-400 dark:hover:text-orbBlue-300">Contact our support team</Link>.
              </p>
            </motion.div>
          </div>
        </div>
